...
public class SecondScoreTestor {
	...
	public void NinthFrameTestScore(){
		EightFrameTestScore();
		player1.getFrame(8).setFristBallScore(8);
		player1.getFrame(8).setSecondBallScore(2);
		assertEquals(76,player1.getFrame(8).getScore());
		assertEquals(76,player1.getFrame(7).getScore());
	}
	...
	public void TenthFrameTestScore(){
		...
		assertEquals(100,player1.getFrame(9).getScore());
		assertEquals(92,player1.getFrame(8).getScore());
	...
	public void TenthFrameSpareTestScore(){
		NinthFrameTestScore();
		player1.getFrame(9).setFristBallScore(6);
		player1.getFrame(9).setSecondBallScore(4);
		player1.getFrame(9).setThirdBallScore(3);
		
		assertEquals(105,player1.getFrame(9).getScore());
		assertEquals(92,player1.getFrame(8).getScore());
	}
	
	@Test
	public void TenthFrameStrikeTestScore(){
		NinthFrameTestScore();
		player1.getFrame(9).setFristBallScore(10);
		player1.getFrame(9).setSecondBallScore(10);
		player1.getFrame(9).setThirdBallScore(10);
		
		assertEquals(126,player1.getFrame(9).getScore());
		assertEquals(96,player1.getFrame(8).getScore());
	}
}
